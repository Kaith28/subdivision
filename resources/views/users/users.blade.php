                            ...
                            <tr>
                                ...
                                <td class="px-2">
                                    <div class="flex justify-center gap-2">
                                        <a href={{ route('users.show', $user->id) }} class=" px-2 py-2 "><svg
                                        ...
                                        <a href={{ route('users.edit', $user->id) }} class=" px-4 py-2 "><svg
                                                xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                        ...
                                        <form action={{ route('users.destroy', $user->id) }} method="POST">
                                            @csrf
                                            <button class="px-2 py-2 "><svg xmlns="http://www.w3.org/2000/svg"
