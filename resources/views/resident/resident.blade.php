                            ...
                            <tr class="hover:bg-gray-200 rounded-md" rounded-md>
                                ...
                                <td class="px-2 text-center">
                                    <div class="flex justify-center gap-2">
                                        ...
                                        @endif
                                        {{--testing--}}
                                        @if (Auth::user()->role == 'admin' || Auth::user()->role == 'owner' || Auth::user()->role == 'admin')
                                        <a href={{ route('relatives.create', $relatives->id) }}
                                            class=" px-4 py-2 hover:bg-gray-200 rounded-md"><svg
                                                xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                fill="currentColor" class="bi bi-people-fill-add"
                                                viewBox="0 0 16 16">
                                                <path
                                                    d="M12.5 16a3.5 3.5 0 1 0 0-7 3.5 3.5 0 0 0 0 7Zm.5-5v1h1a.5.5 0 0 1 0 1h-1v1a.5.5 0 0 1-1 0v-1h-1a.5.5 0 0 1 0-1h1v-1a.5.5 0 0 1 1 0Zm-2-6a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" />
                                                <path
